  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <div className="bg-card rounded-2xl p-6 md:p-8 shadow-sm border border-border-subtle mb-8">
        <div className="inline-flex items-center gap-2 bg-warm-indigo/10 text-warm-indigo text-xs font-bold px-3 py-1 rounded-full mb-4">
          <Award className="w-4 h-4 text-gold-warm" /> Academic Capstone Project (B.Tech CSE)
        </div>

        <h1 className="font-serif text-3xl font-bold text-warm-indigo mb-3">Project Sanjeevani</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t pt-6">
          <div>
            ...
            <p className="font-bold text-warm-indigo text-base">Mr. Rajendra Kumar</p>
          ...
          <div>
            ...
            <p className="font-bold text-warm-indigo text-base">IT Gopeshwar, Chamoli</p>
            <p className="text-xs text-muted">VMSB Uttarakhand Technical University</p>
          </div>
        </div>
      </div>

      <h3 className="font-serif text-xl font-bold text-warm-indigo mb-4 flex items-center gap-2">
        <Users className="w-5 h-5 text-sage" /> Development Team
      </h3>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {teamMembers.map((member, idx) => (
          <div key={idx} className="bg-card p-4 rounded-xl border border-border-subtle shadow-sm">
            <h4 className="font-bold text-warm-indigo">{member.name}</h4>
